...
# The original code is part of nltk_contrib library.

# This code is a slight modification of the original code to capture more complex date, time events.
# Modifications by Jitendra Harlalka
...
# Predefined strings.
dofm1="(first|second|third|fourth|fifth|sixth|seventh|eighth|ninth)"
dofm2="(tenth|eleventh|twelfth|thirteenth|fourteenth|fifeenth|sixteenth|seventeenth| \
	eighteenth|nineteenth|twentieth|thirtieth|thirty[ -]first)"
dofmd="(1st|2nd|3rd|4th|5th|6th|7th|8th|9th|10th|11th|12th|13th|14th|15th|16th| \
	17th|18th|19th|20th|21st|22nd|23rd|24th|25th|26th|27th|28th|29th|30th|31st)"
dayOfm="([1-9]|1[0-9]|2[0-9]|3[0-1])"
...
regxp3 = "("+ dofm1+"|"+dofm2+"|(twenty[-\s]?"+dofm1+"))"
regxp4 = "("+regxp3+"([-\s]"+month+")?)"
regxp5 = "("+dofmd+"([-\s]"+month+")?)"
regxp6 = "("+dayOfm+"($|\s)("+month+")?)"
